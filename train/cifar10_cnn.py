...
from models.threelayerconv import ThreeLayerConv # 导入三层的卷积神经网络
...
def main(ckpt, device, seed, lr, epochs, batch_size, optimizer_name="sgd", momentum=None):
    ...
    model = ThreeLayerConv().to(device)
...
if __name__ == "__main__":
    MODEL_TYPE_NAME = "2_cifar10_cnn"
    OUTPUT_DIR_MAIN = "2_cifar10_cnn_checkpoints"
    OUTPUT_DIR_MOMENTUM = "2_cifar10_cnn_checkpoints_momentum"
